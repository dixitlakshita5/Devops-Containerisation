...
2. To install and configure Containers using Docker inside WSL.
...
1. Install Docker Desktop for Mac - _Screenshot_ ![Docker Installation](images/dockerInstallation.png)
